...
import rawPortfolioShipments from './data/portfolio_shipments.json'
import rawChargebacks from './data/chargebacks.json'
...
export const portfolioShipments = rawPortfolioShipments as unknown as PortfolioShipment[]
export const chargebackRows = rawChargebacks as unknown as ChargebackRow[]
