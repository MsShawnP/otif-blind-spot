...
Your fill rate says 99%. Walmart scores you at 85%. This tool
shows where the 15-point gap comes from and what it costs.
...
The gap is almost entirely in-full (12.7 of 14.8 pts). On-time
performance is strong. The blind spot is quantity shortfalls: a
shipment that ships 99% of its units scores 99% on fill rate but
0% on OTIF.
...
Short-ships drive 72% of the gap. Receiving discrepancies — where
the dock scan disagrees with what was shipped — account for 14%.
The brand's internal metrics never see these. That is the blind
spot.
...
scores. The gap turned out to be 15 points, not 10 — still a
significant finding, and the honest one.
